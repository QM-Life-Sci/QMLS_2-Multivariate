...
Identify a paper from the primary literature that has a dataset that has been or could be analyzed using one of the methods we've covered in this module. Perform the analysis in R, either reproducing what the paper has done or analyzing the dataset in a new way if you think that is appropriate and useful. Write a short description summarizing the dataset and how it was collected and the analysis methods and results you have found. Especially highlight any differences in your analysis compared to the original publication. The entire thing should be written in this `.qmd` file, formatting the analysis, plots, etc. here. 
