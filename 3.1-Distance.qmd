...
Symmetric (Mantel, CanCorrel) vs. Asymmetric analysis (Ordination & Regression: MANOVA, CanCorresp, RDA, LDA)
...
- `ecodist::distance()`: `euclidean`, `manhattan`, `jaccard`, `sorensen`, `bray` [@Goslee2007-mt]
